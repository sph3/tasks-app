  ...
  return (
    <div className='flex flex-row justify-between items-center text-center h-16 bg-ctp-crust flex-wrap px-1'>
      <div className='w-[calc(100%/3)]'>
        <button className='bg-ctp-surface2 w-10 h-10 rounded-lg flex text-center items-center justify-center outline-none hover:brightness-90 duration-100 focus:ring-ctp-overlay2 focus:ring-2'>
